/*
  Epsilon.c - version corrigée
  Notes :
  - Pour WH_KEYBOARD_LL et WH_MOUSE_LL on utilise GetModuleHandle(NULL)
  - Le code convertit les VK en caractères quand possible via ToAscii
  - Le message loop utilise un MSG correctement déclaré
*/
